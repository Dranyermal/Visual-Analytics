...
Our group intends to conduct descriptive, inferential and time-series analysis on the datasets in order to glean important information about hawker centres as well as the possible correlations that are able to be drawn from it.
